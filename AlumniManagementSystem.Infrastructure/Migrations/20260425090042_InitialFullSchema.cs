    ...
    public partial class InitialFullSchema : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Description = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    HodName = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    NewsletterId = table.Column<Guid>(type: "char(36)", nullable: false, collation: "ascii_general_ci"),
                    Title = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CurrentJobTitle = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    CurrentCompany = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Alumnis", x => x.AlumniId);
                    table.ForeignKey(
                        name: "FK_Alumnis_Programs_ProgramId",
                        column: x => x.ProgramId,
                        principalTable: "Programs",
                        principalColumn: "ProgramId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Alumnis_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "UserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_NewsletterRecipients", x => x.RecipientId);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_NewsletterRecipients_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "UserId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Contacts_Alumnis_AlumniId",
                        column: x => x.AlumniId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Campaign = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Donations_Alumnis_AlumniId",
                        column: x => x.AlumniId,
                        principalTable: "Alumnis",
                        principalColumn: "AlumniId",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    RsvpId = table.Column<Guid>(type: "char(36)", nullable: false, collation: "ascii_general_ci"),
                    EventId = table.Column<Guid>(type: "char(36)", nullable: false, collation: "ascii_general_ci"),
                    AlumniId = table.Column<Guid>(type: "char(36)", nullable: false, collation: "ascii_general_ci"),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_EventRSVPs_Alumnis_AlumniId",
                        column: x => x.AlumniId,
                        principalTable: "Alumnis",
                        principalColumn: "AlumniId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_JobPostings_Alumnis_PostedBy",
                        column: x => x.PostedBy,
                        principalTable: "Alumnis",
                        principalColumn: "AlumniId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SurveyResponses_Alumnis_AlumniId",
                        column: x => x.AlumniId,
                        principalTable: "Alumnis",
                        principalColumn: "AlumniId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Alumnis_ProgramId",
                table: "Alumnis",
                column: "ProgramId");

            migrationBuilder.CreateIndex(
                name: "IX_Alumnis_RollNumber",
                table: "Alumnis",
                column: "RollNumber",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EventRSVPs_AlumniId",
                table: "EventRSVPs",
                column: "AlumniId");

            migrationBuilder.CreateIndex(
                name: "IX_EventRSVPs_EventId_AlumniId",
                table: "EventRSVPs",
                columns: new[] { "EventId", "AlumniId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_NewsletterRecipients_NewsletterId_UserId",
                table: "NewsletterRecipients",
                columns: new[] { "NewsletterId", "UserId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_NewsletterRecipients_UserId",
                table: "NewsletterRecipients",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SurveyResponses_AlumniId",
                table: "SurveyResponses",
                column: "AlumniId");

            migrationBuilder.CreateIndex(
                name: "IX_SurveyResponses_SurveyId_AlumniId",
                table: "SurveyResponses",
                columns: new[] { "SurveyId", "AlumniId" },
                unique: true);
